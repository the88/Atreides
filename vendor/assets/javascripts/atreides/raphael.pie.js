    ...
    var angle = 0,
        ...
        process = function (j) {
            var value = values[j],
                ...
                txt = paper.text(cx + (r + delta + 25) * Math.cos(-popangle * rad), cy + (r + delta + 5) * Math.sin(-popangle * rad), labels[j]).attr({fill: '#fff', stroke: "none", opacity: 0, "font-family": "'Helvetica Neue',Arial,Helvetica,sans-serif", "font-size": "15px"});
